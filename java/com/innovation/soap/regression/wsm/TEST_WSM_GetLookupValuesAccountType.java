...
public class TEST_WSM_GetLookupValuesAccountType
{
	@Parameters({ "strEnvironmentName" })
	@Test
	public void generateWSMGetLookupValuesAccountType (@Optional("Java8") String strEnvironmentName) throws Exception
	{
		Map<String, String> tokensMap = new HashMap<String, String> ();
		tokensMap.put ("AttributeName", "MISCDATA");
		tokensMap.put ("Company", "8880");
		tokensMap.put ("Language", "en");
		tokensMap.put ("LookUpName", "LKAccountTypes");
