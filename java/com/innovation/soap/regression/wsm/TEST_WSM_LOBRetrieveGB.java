...
public class TEST_WSM_LOBRetrieveGB
{
	@Parameters({ "strEnvironmentName" })
	@Test
	public void generateWSMLOBRetrieveGB (@Optional("Java8") String strEnvironmentName) throws Exception
	{
		Map<String, String> tokensMap = new HashMap<String, String> ();
		tokensMap.put ("LOBCompany", "8880");
		tokensMap.put ("DateType", "yyyymmdd");
		tokensMap.put ("EffectDate", "27/02/2018");
		tokensMap.put ("RiskState", "GB");
		tokensMap.put ("Subcoy", "880");
