...
/**
 * @author Rizwan - Sprint 32 - Regression Test AT-217453: To verify the task generated upon successful MOJ Exit Process of CNF with
 *         status InterimPaymentDecision
 * @PreReq MOJ Claim status should be in “Interim payment decision”
 * 
 * @ExpectedResults A new task “MOJ process exited” should be raised with 1 day due and 2 day deadline and a description, “The claim
 *                  has exited from the MOJ process at phase <Status immediately before Exit process> and will need to be
 *                  progressed. Please review and generate the necessary manual tasks for this processing.”
 */
public class TEST_AT217453_ExitProcess_TaskGenerated extends DriverManager
{
	@Parameters({ "strBrowser", "strEnvironmentName", "strEnvironmentBrand", "strRegionValue", "strCompany" })
	@Test
	public void testAT217453ExitProcessTaskGenerated (@Optional("CHROME") String strBrowser, @Optional("BaseDevelopment") String strEnvironmentName,
			...
			throws Exception
	{
		...
		String strTaskDetails = "The claim has exited from the MOJ process at phase Interim payment decision and will need to be progressed outside of the MOJ portal processing. Please review and generate the necessary manual tasks for this processing.";
