...
/**
 * @author Rizwan - Sprint 35 - Regression Test AT-219430: To Verify the audit generated after Stage 2 settlement pack is received
 * 
 * @Pre-req MOJ Claim status should be in “Stage 2 settlement pack decision”
 * 
 * @ExpectedResults After Stage 2 settlement pack received, an audit "Stage 2 settlement pack received. Total net damages claimed to
 *                  date £<Total Net Damages Claimed To date>" should be generated
 */

public class TEST_AT219430_Stage2SettlementPackRecieved_AuditGenerated extends DriverManager
{
	@Parameters({ "strBrowser", "strEnvironmentName", "strEnvironmentBrand", "strRegionValue", "strCompany" })
	@Test
	public void testForAT219430_Stage2SettlementPackRecieved_AuditGenerated (@Optional("CHROME") String strBrowser,
			...
			@Optional("UK") String strRegionValue, @Optional("8880") String strCompany) throws Exception
	{
		...
		String strTotalNetDamagesClaimedTodate;
		...
		// Get value of Total net damage claimed to date
		seleniumwaiter.waitForMe (GlobalWaitTime.getIntWaitTime ());
		strTotalNetDamagesClaimedTodate = mojactions.returnTotalNetDamagesClaimedTodateStage2Settlement ();
		...
		// Validate the audit generated after receiving of Stage 2 settlement pack
		seleniumwaiter.waitForMe (GlobalWaitTime.getIntWaitTime ());
		strAuditGenerated = "Stage 2 settlement pack received. Total net damages claimed to date £" + strTotalNetDamagesClaimedTodate;
