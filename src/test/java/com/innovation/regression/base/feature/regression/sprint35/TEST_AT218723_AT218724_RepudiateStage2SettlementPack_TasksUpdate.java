...
/**
 * @author Rizwan - Sprint 35 - Regression Test AT-218723 & AT-218724: To Verify tasks generated and tasks completed in successful
 *         repudiation of stage 2 settlement pack
 * 
 * @Pre-req MOJ Claim status should be in “Stage 2 settlement pack decision”
 * 
 * @ExpectedResults After repudiating Stage 2 settlement pack, a new task, MOJ process exited should be raised with 1 day due, 2
 *                  days deadline and a description “The claim has exited from the MOJ process at phase <Current phase> and will
 *                  need to be progressed outside of the MOJ portal processing. Please review and generate the necessary manual
 *                  tasks for this processing. An existing task "Stage 2.2 Settlement pack received" should be automatically
 *                  completed
 * 
 */

public class TEST_AT218723_AT218724_RepudiateStage2SettlementPack_TasksUpdate extends DriverManager
{
	@Parameters({ "strBrowser", "strEnvironmentName", "strEnvironmentBrand", "strRegionValue", "strCompany" })
	@Test
	public void testForAT218723_AT218724_RepudiateStage2SettlementPack_TasksUpdate (@Optional("CHROME") String strBrowser,
			...
			@Optional("UK") String strRegionValue, @Optional("8880") String strCompany) throws Exception
	{
		...
		String strTaskDetails = "The claim has exited from the MOJ process at phase Stage 2 settlement pack repudiation and will need to be progressed outside of the MOJ portal processing. Please review and generate the necessary manual tasks for this processing.";
		String strTaskCompleted = "Stage 2 settlement pack review";
		...
		// Check task "Stage 2 settlement pack review" completed successfully
