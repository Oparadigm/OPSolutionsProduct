...
/**
 * @author Rizwan - Sprint 34 - Regression Test AT-219855: To verify the tasks completed and generated upon stating fraud in MOJ
 *         claim with status of Interim Payment Decision
 * @PreReq MOJ Claim status should be in “Interim payment decision”
 * 
 * @ExpectedResults Interim settlement request task that should be cancelled
 * 
 *                  New task “MOJ process exited” should be raised with 1 day due and 2-day deadline and a description, “The claim
 *                  has exited from the MOJ process at phase <Phase immediately prior> as fraud is suspected. Please review and
 *                  generate any necessary manual tasks for further processing.” <Phase immediately prior> will be in this case
 *                  InterimPaymentDecision
 * 
 * 
 */
public class TEST_AT219855_FraudStatedInInterimSettlementPack_TasksUpdated extends DriverManager
{
	@Parameters({ "strBrowser", "strEnvironmentName", "strEnvironmentBrand", "strRegionValue", "strCompany" })
	@Test
	public void testForAT219855_FraudStatedInInterimSettlementPack_TasksUpdated (@Optional("CHROME") String strBrowser,
			@Optional("Athena") String strEnvironmentName, @Optional("Model Office UK") String strEnvironmentBrand, @Optional("UK") String strRegionValue,
			@Optional("8880") String strCompany) throws Exception
	{
		...
		String strTaskCancelled = "Interim settlement pack review";
		String strTaskDetails = "The claim has exited from the MOJ process at phase Interim payment decision as fraud is suspected. Please review and generate any necessary manual tasks for further processing.";
		...
		// Check task "Interim settlement pack review" cancelled successfully
		seleniumwaiter.waitForMe (GlobalWaitTime.getIntWaitTime ());
