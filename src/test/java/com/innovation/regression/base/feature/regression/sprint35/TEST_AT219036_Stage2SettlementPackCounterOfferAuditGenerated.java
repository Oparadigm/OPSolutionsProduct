...
/**
 * @author haiderm - Sprint 35 - Regression Test AT-219036: To verify that if counter offer message is successful , audit should be
 *         generated successfully
 * 
 * @Pre-req CNF should be in Stage2SettlementPackDecision
 * 
 * @ExpectedResults an audit should be generated having following specification:
 * 
 *                  MOJ Stage 2 settlement pack, text - Response sent - Counter offer. Net value of offer £{1}
 * 
 */
public class TEST_AT219036_Stage2SettlementPackCounterOfferAuditGenerated extends DriverManager
{
	@Parameters({ "strBrowser", "strEnvironmentName", "strEnvironmentBrand", "strRegionValue", "strCompany" })
	@Test
	public void testForAT219036 (@Optional("CHROME") String strBrowser, @Optional("BaseDevelopment") String strEnvironmentName,
			...
			throws Exception
	{
		...
		strValueOffered = mojactions.returnNetValueOfOfferStage2Settlement ();
		...
		// Validate audit generated
		seleniumwaiter.waitForMe (GlobalWaitTime.getIntWaitTime ());
		strAuditGenerated = "Response sent - " + strSettlementPackDecision + ". " + "Net value of offer £" + strValueOffered;
