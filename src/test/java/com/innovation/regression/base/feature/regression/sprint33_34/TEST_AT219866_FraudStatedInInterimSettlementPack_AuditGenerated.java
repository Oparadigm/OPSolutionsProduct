...
/**
 * @author Rizwan - Sprint 34 - Regression Test AT-219866: To verify the audit generated upon stating fraud in MOJ claim with status
 *         of Interim Payment Decision
 * @PreReq MOJ Claim status should be in “Interim payment decision”
 * 
 * @ExpectedResults An audit "Claim fraud stated" should be generated on stating fraud in MOJ claim with Interim Payment Decision
 * 
 * 
 */
public class TEST_AT219866_FraudStatedInInterimSettlementPack_AuditGenerated extends DriverManager
{
	@Parameters({ "strBrowser", "strEnvironmentName", "strEnvironmentBrand", "strRegionValue", "strCompany" })
	@Test
	public void testForAT219866_FraudStatedInInterimSettlementPack_AuditGenerated (@Optional("CHROME") String strBrowser,
			...
			@Optional("UK") String strRegionValue, @Optional("8880") String strCompany) throws Exception
	{
		...
		String strAuditGenerated = "Claim fraud stated";
		...
		// Validate the audit "Claim fraud stated" is generated
		seleniumwaiter.waitForMe (GlobalWaitTime.getIntWaitTime ());
