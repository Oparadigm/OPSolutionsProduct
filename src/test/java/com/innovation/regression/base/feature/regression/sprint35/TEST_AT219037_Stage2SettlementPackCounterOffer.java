...
/**
 * @author haiderm - Sprint 35 - Regression Test AT-219037: To verify that if counter offer message is successful the status should
 *         be updated to “Stage 2 Settlement pack Counter Offer Decision”
 * 
 * @Pre-req CNF should be in Stage2SettlementPackDecision
 * 
 * @ExpectedResults The status should be updated to “Stage 2 Settlement pack Counter Offer Decision”
 * 
 */
public class TEST_AT219037_Stage2SettlementPackCounterOffer extends DriverManager
{

	@Parameters({ "strBrowser", "strEnvironmentName", "strEnvironmentBrand", "strRegionValue", "strCompany" })
	@Test
	public void testForAT219037 (@Optional("CHROME") String strBrowser, @Optional("BaseDevelopment") String strEnvironmentName,
