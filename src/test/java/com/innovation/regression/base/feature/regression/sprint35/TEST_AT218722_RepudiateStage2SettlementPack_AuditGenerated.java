...
/**
 * @author Rizwan - Sprint 35 - Regression Test AT-218722: To Verify audit generation in successful repudiation of stage 2
 *         settlement pack
 * 
 * @Pre-req MOJ Claim status should be in “Stage 2 settlement pack decision”
 * 
 * @ExpectedResults After repudiating Stage 2 settlement pack, an audit "Response sent - Repudiated" should be generated for the
 *                  Repudiation of the Stage 2.2 Settlement pack.
 * 
 */

public class TEST_AT218722_RepudiateStage2SettlementPack_AuditGenerated extends DriverManager
{
	@Parameters({ "strBrowser", "strEnvironmentName", "strEnvironmentBrand", "strRegionValue", "strCompany" })
	@Test
	public void testForAT218722_RepudiateStage2SettlementPack_AuditGenerated (@Optional("CHROME") String strBrowser,
			...
			@Optional("UK") String strRegionValue, @Optional("8880") String strCompany) throws Exception
	{
		...
		String strAuditGenerated = "Response sent - Repudiated";
		...
		// Validate audit "Response sent - Repudiated" generated on repudiating Stage 2 Settlement pack
		seleniumwaiter.waitForMe (GlobalWaitTime.getIntWaitTime ());
