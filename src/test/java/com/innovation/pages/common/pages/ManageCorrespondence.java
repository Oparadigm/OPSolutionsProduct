...
import com.innovation.pages.common.objects.OR_ManageCorrespondence;

/**
 * @author Alamq. This class stores all the locators and methods in Correspondence Out.
 *
 */
public class ManageCorrespondence
{
	WebDriver				driver;
	LoggingControl			loggingcontrol					= new LoggingControl ();
	OR_ManageCorrespondence	or_ClaimCorrespondenceSummary	= null;
	OR_ControlPanel			orControlPanel					= null;

	public ManageCorrespondence (WebDriver driver)
	{
		this.driver = driver;
		or_ClaimCorrespondenceSummary = PageFactory.initElements (driver, OR_ManageCorrespondence.class);
	...
	public void selectRandomDocuments ()
	{
		...
		// tablehandler.clickRandomTableRowWithText ("CLM_SC_0155_CorrespondenceOut", "Delivered");
		tablehandler.returnRowInTableWithText ("CLM_SC_0155_CorrespondenceOut", "Delivered");
